					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
							<div class="footer-widget recent-blog">
								...
								<div>
									<a href="m203rail.html"class="text-white">M203 Underbarrel Rail</a>
									<p class="text-sm mt-2 text-white-50">11 ตุุลาคม 2025</p>
								</div>
								<div class="mt-4">
									<a href="mp9sup.html"class="text-white">MP9 Suppressor</a>
									<p class="text-sm mt-2 text-white-50">3 ตุุลาคม 2025</p>
								</div>
						...
						<div class="col-lg-2 col-md-5 mb-5 mb-lg-0">
							<div class="footer-widget">
								...
								<ul class="list-unstyled footer-menu lh-40 mb-0">
									...
									<li><a href="paint-blog/paintjob-1.html"><i class="ti-angle-double-right mr-2"></i>Paint & Modify</a></li>
									<li><a href="prob-3d-blog/3d-model-1.html"><i class="ti-angle-double-right mr-2"></i>Prob & 3D</a></li>
								</ul>
							</div>
						</div>
